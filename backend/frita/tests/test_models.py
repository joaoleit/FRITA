...
class ModelsTestCase(TestCase):
    ...
    def setUp(self):
        ScrumMaster.objects.create(
            name="vinicius", email="vinicius@gmail.com", password="123")
        ScrumMaster.objects.create(
            name="joao", email="joao@gmail.com", password="123456")
        Project.objects.create(
            name="hi", creator=ScrumMaster.objects.get(name="vinicius"))
    ...
    def test_scrummaster_password_length(self):
        vini = ScrumMaster.objects.get(name="vinicius")
        self.assertEqual(len(vini.password), 3)

    def test_project(self):
        project = Project.objects.get(name="hi")
        self.assertEqual(project.name, "hi")
        self.assertEqual(
            project.creator, ScrumMaster.objects.get(name="vinicius"))
